...
走近伙伴按交互键可打开生活菜单，完成初次设置，选择"随便聊聊"或"商量计划"，以及查看、修改或删除约定。这两种对话只提供聊天和建议，不会派发或取消农活；要交代具体工作，选"帮我做件事"进入 F8 指令菜单。伙伴忙时会提示排队并在稍后回复。设置与记忆的操作见[和伙伴一起生活](../README.md#和伙伴一起生活)。
